...
const btsUniverseFortunes = [
    ...
    { song: "Fire", message: "隨心所欲地去生活吧！反正這是專屬於你的人生。今天偶爾放鬆、偷懶，哪怕輸了也完全沒有關係！", lyrics: "隨便怎麼活都行，反正是你自己的", cover: "./assets/covers/hyyh2.png", spotify: "https://open.spotify.com/track/0aE3V0zgSD2YwkEHW42gxG?si=491b98b268c5463f", apple: "https://music.apple.com/tw/song/burning-up-fire/1598662129" },
...
function initVisitorCount() {
    ...
    const key = 'btsUniverseVisitCount';
    const hasCountedThisSession = sessionStorage.getItem('btsUniverseVisited') === 'true';
    let count = Number(localStorage.getItem(key)) || 0;

    if (!hasCountedThisSession) {
        count += 1;
        localStorage.setItem(key, String(count));
        sessionStorage.setItem('btsUniverseVisited', 'true');
    }

    visitorCountEl.innerText = `瀏覽人數 ${count.toLocaleString('zh-TW')}`;
}
